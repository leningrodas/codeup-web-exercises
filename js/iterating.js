...
//      */
//
//     let names = ["Jose", "Luz", "rachel", "jesse"];
//
//
//
//     /**
...
//      */
//     let first = [1, 2, 3, 4, 5]
//     function theLastOfTheFirst(first){
//         return first[first.length - 5];
//     }
//     console.log(theLastOfTheFirst(first))
//
//     let second = [1, 2, 3, 4, 5]
//     function returnOfTheSecond(second){
//         return second[second.length - 4]
//     }
//     console.log(returnOfTheSecond(second));
//
//     let third = [1, 2, 3, 4, 5]
//     function theEndofTheThird(third){
//         return third[third.length - 1];
//     }
//     console.log(theEndofTheThird(third));
//
//
// })();
...
// var treepie = ["blueberry", "strawberry", "blackberry"]
// function threeMostPies (treepie) {
//
//     return threeMostPies(treepie);
// }
//
// console.log(threeMostPies());
// ============================= Reversing
