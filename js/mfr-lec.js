...
// var mapArray = numbers.map(function (n){
//     return n + 1;
// })
...
//
// let multiArray = numbers.map(function (n){
//     return n * 3;
// })


let multiEs = numbers.map(n=> n * 3);
...
let esones = binary.filter(x=>x);
console.log(esones)

// TODO: filter through binary again and this time, return all the false values.
 const zero = binary.filter(function (x){
     return x == false;
 })
let esZero = binary.filter(x=> !x);
console.log(esZero)
...
const esVeggie = fruitsAndVeggies.filter(produce => produce.type === "fruits");
...
const num  = numbersArray.reduce(function (currentSum, currentNumber){
...
// const numHund  = numbersArray.reduce(function (currentSum, currentNumber){
//     return currentSum - currentNumber;
// }, 100);
// console.log(numHund);
...
const applArr  = shoppingCarts.reduce(function (currentSum, {bananas}){
    return currentSum + bananas;
}, 0);
console.log(applArr);
